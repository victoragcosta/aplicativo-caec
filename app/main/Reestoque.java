...
public class Reestoque {
	...
	private void initialize(Estoque estoque) {
		...
		if(estoque.quantBebidas >= 1){
			...
			textFieldBebida[0] = new JTextField("0");
		...
		if(estoque.quantBebidas >= 2){
			...
			textFieldBebida[1] = new JTextField("0");
		...
		if(estoque.quantBebidas >= 3){
			...
			textFieldBebida[2] = new JTextField("0");
		...
		if(estoque.quantBebidas >= 4){
			...
			textFieldBebida[3] = new JTextField("0");
		...
		if(estoque.quantBebidas >= 5){
			...
			textFieldBebida[4] = new JTextField("0");
		...
		if(estoque.quantBebidas >= 6){
			...
			textFieldBebida[5] = new JTextField("0");
		...
		if(estoque.quantBebidas >= 7){
			...
			textFieldBebida[6] = new JTextField("0");
		...
		if(estoque.quantBebidas >= 8){
			...
			textFieldBebida[7] = new JTextField("0");
		...
		if(estoque.quantBebidas >= 9){
			...
			textFieldBebida[8] = new JTextField("0");
		...
		if(estoque.quantSnacks >= 1){
			...
			textFieldSnack[0] = new JTextField("0");
		...
		if(estoque.quantSnacks >= 2){
			...
			textFieldSnack[1] = new JTextField("0");
		...
		if(estoque.quantSnacks >= 3){
			...
			textFieldSnack[2] = new JTextField("0");
		...
		if(estoque.quantSnacks >= 4){
			...
			textFieldSnack[3] = new JTextField("0");
		...
		if(estoque.quantSnacks >= 5){
			...
			textFieldSnack[4] = new JTextField("0");
		...
		if(estoque.quantSnacks >= 6){
			...
			textFieldSnack[5] = new JTextField("0");
		...
		if(estoque.quantSnacks >= 7){
			...
			textFieldSnack[6] = new JTextField("0");
		...
		if(estoque.quantSnacks >= 8){
			...
			textFieldSnack[7] = new JTextField("0");
		...
		if(estoque.quantSnacks >= 9){
			...
			textFieldSnack[8] = new JTextField("0");
		...
		if(estoque.quantSnacks >= 10){
			...
			textFieldSnack[9] = new JTextField("0");
		...
		if(estoque.quantSnacks >= 11){
			...
			textFieldSnack[10] = new JTextField("0");
		...
		if(estoque.quantSnacks >= 12){
			...
			textFieldSnack[11] = new JTextField("0");
		...
		if(estoque.quantSnacks >= 13){
			...
			textFieldSnack[12] = new JTextField("0");
		...
		if(estoque.quantSnacks >= 14){
			...
			textFieldSnack[13] = new JTextField("0");
		...
		if(estoque.quantSnacks >= 15){
			...
			textFieldSnack[14] = new JTextField("0");
		...
		if(estoque.quantSnacks >= 16){
			...
			textFieldSnack[15] = new JTextField("0");
		...
		if(estoque.quantSnacks >= 17){
			...
			textFieldSnack[16] = new JTextField("0");
		...
		if(estoque.quantSnacks >= 18){
			...
			textFieldSnack[17] = new JTextField("0");
		...
		if(estoque.quantOutros >= 1){
			...
			textFieldOutro[0] = new JTextField("0");
		...
		if(estoque.quantOutros >= 2){
			...
			textFieldOutro[1] = new JTextField("0");
		...
		if(estoque.quantOutros >= 3){
			...
			textFieldOutro[2] = new JTextField("0");
		...
		if(estoque.quantOutros >= 4){
			...
			textFieldOutro[3] = new JTextField("0");
		...
		if(estoque.quantOutros >= 5){
			...
			textFieldOutro[4] = new JTextField("0");
		...
		if(estoque.quantOutros >= 6){
			...
			textFieldOutro[5] = new JTextField("0");
		...
		if(estoque.quantOutros >= 7){
			...
			textFieldOutro[6] = new JTextField("0");
		...
		if(estoque.quantOutros >= 8){
			...
			textFieldOutro[7] = new JTextField("0");
		...
		if(estoque.quantOutros >= 9){
			...
			textFieldOutro[8] = new JTextField("0");
					...
					while(informacaoProduto != null){
						...
						if(produtoTemp[3].equals("bebida")){
							if(textFieldBebida[percorre].getText().equals("")){
								textFieldBebida[percorre].setText("0");
							}
							try{
								int novaQuant = Integer.parseInt(textFieldBebida[percorre].getText());
								novaQuant += estoque.bebidas[percorre].getQuantidade();
								quantidade = String.valueOf(novaQuant);
						...
						if(produtoTemp[3].equals("snack")){
							if(textFieldSnack[percorre].getText().equals("")){
								textFieldSnack[percorre].setText("0");
							}
							try{
								int novaQuant = Integer.parseInt(textFieldSnack[percorre].getText());
								novaQuant += estoque.snacks[percorre].getQuantidade();
								quantidade = String.valueOf(novaQuant);
						...
						if(produtoTemp[3].equals("outro")){
							if(textFieldOutro[percorre].getText().equals("")){
								textFieldOutro[percorre].setText("0");
							}
							try{
								int novaQuant = Integer.parseInt(textFieldOutro[percorre].getText());
								novaQuant += estoque.outros[percorre].getQuantidade();
								quantidade = String.valueOf(novaQuant);
