		...
		public void actionPerformed(ActionEvent e){
			...
			if(e.getSource() == button1){
				...
				try{
					...
					JOptionPane.showMessageDialog(Example2.this, "Please Enter the Right Info", "Error", JOptionPane.ERROR_MESSAGE);
				...
				if(dollarSign.isSelected()) {
					...
					JOptionPane.showMessageDialog(Example2.this, numFormat.format(totalCalc), "Solution", JOptionPane.INFORMATION_MESSAGE);
				...
				JOptionPane.showMessageDialog(Example2.this, totalCalc, "Solution", JOptionPane.INFORMATION_MESSAGE);
